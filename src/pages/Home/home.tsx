    ...
    <div className='grid gap-30 lg:grid-cols-2 mt-10 mb-40'>
        <div className='grid grid-rows-4 gap-4 h-fit lg:px-10'>
            ...
            <div className='grid grid-cols-2 sm:grid-cols-3 items-start gap-2 h-fit my-auto'>
               <Button variant={'default'} className='text-base py-6 px-4'>Get Started Now</Button>
        ...
        <div className='relative w-full max-w-5xl flex flex-col md:flex-row items-center justify-center md:ml-5 h-full'>
            <Image
                    src={heroimage}
                    alt="Picture of the author"
                ...
                <Image
                    src={cardexpenes}
                    alt="Picture of the author"
                    className='absolute bottom-[-20px] xs:bottom-[50px] md:bottom-[150px] sm:left-[-40px] xl:bottom-[-40px] left-4 xl:left-[-100px] w-1/2 rounded-xl shadow-xl'
                    />
        </div>
    </div>
  )
